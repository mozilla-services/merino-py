...
from common.client_info import DESKTOP_FIREFOX, LOCALES
...
CANADA_IP_ADDRESS_RANGES_GZIP: str = (
    "tools/load-tests/data/ip2location_canada_ip_address_ranges.gz"
)
US_IP_ADDRESS_RANGES_GZIP: str = (
    "tools/load-tests/data/ip2location_united_states_of_america_ip_address_ranges.gz"
)
