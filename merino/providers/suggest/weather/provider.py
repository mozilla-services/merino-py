...
from merino.governance.circuitbreakers import WeatherCircuitBreaker, _hourly_forecasts_fallback
...
class Provider(BaseProvider):
    ...
    @WeatherCircuitBreaker(
        name="weather", fallback_function=_hourly_forecasts_fallback
