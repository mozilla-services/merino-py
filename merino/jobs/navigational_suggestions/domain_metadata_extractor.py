        ...
        try:
            ...
            if manifest_tasks:
                ...
                for i in range(0, len(manifest_tasks), chunk_size):
                    ...
                    scraped_favicons_list = await asyncio.gather(*chunk)
                    for manifest_absolute_url, scraped_favicons_result in zip(
                        chunk_urls, scraped_favicons_list
                    ):
    ...
    async def _get_best_favicon(self, favicons: list[dict[str, Any]], min_width: int) -> str:
        ...
        try:
            ...
            for i in range(0, len(urls), chunk_size):
                ...
                chunk_images = await self.favicon_downloader.download_multiple_favicons(chunk_urls)
