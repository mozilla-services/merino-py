...
def get_top_n_frequency(language, top_n, tempdir ) -> list[dict]:
    ...
    dir = os.getcwd()
    print("Contents of temp dir:", os.listdir(tempdir))
    with open(f"{dir}/merino/jobs/wikipedia_offline_uploader/page_ignore.csv") as f, open(f"{dir}/merino/jobs/wikipedia_offline_uploader/dynamic_wikipedia_blocklist.csv") as g:
        ignored = set(
