...
class ExperimentName(str, Enum):
    ...
    # Experiment to apply 8-tile-double-row layout with an ad in each row on the "Popular Today" section
    ML_SECTIONS_POPULAR_TODAY_DOUBLE_ROW_EXPERIMENT = "new-tab-double-row-popular-today"
    # Experiment to compare RSS vs. Zyte content sources for legacy topic sections
    RSS_VS_ZYTE_EXPERIMENT = "new-tab-crawl"
