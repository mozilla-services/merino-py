...
from merino.curated_recommendations.prior_backends.experiment_rescaler import SUBSECTION_EXPERIMENT_PERCENT
...
class MockEngagementBackend(EngagementBackend):
    ...
    def get(self, corpus_item_id: str, region: str | None = None) -> Engagement | None:
        ...
        HIGH_CTR_ITEMS = {
            "b2c10703-5377-4fe8-89d3-32fbd7288187": (1_000_000 * ML_EXPERIMENT_SCALE, 1_000_000 * ML_EXPERIMENT_SCALE),  # ML music 100% CTR
            "f509393b-c1d6-4500-8ed2-29f8a23f39a7": (1_000_000 * ML_EXPERIMENT_SCALE, 1_000_000 * ML_EXPERIMENT_SCALE),  # ML NFL 100% CTR
            "2afcef43-4663-446e-9d69-69cbc6966162": (1_000_000 * ML_EXPERIMENT_SCALE, 1_000_000 * ML_EXPERIMENT_SCALE),  # ML Movies 100% CTR
            "dc4b30c4-170b-4e9f-a068-bdc51474a0fb": (1_000_000 * ML_EXPERIMENT_SCALE, 1_000_000 * ML_EXPERIMENT_SCALE),  # ML Soccer 100% CTR
            "9261e868-beff-4419-8071-7750d063d642": (1_000_000 * ML_EXPERIMENT_SCALE, 1_000_000 * ML_EXPERIMENT_SCALE),  # ML NBA 100% CTR
