...
@pytest.mark.parametrize(
    ...
    ids=[
        "Case-I: A-timed-out-provider",
        "Case-II: A-non-timed-out-and-a-timed-out-providers",
        "Case-III: A-timed-out-tolerant-provider",
        "Case-IV: A-non-timed-out-and-a-timed-out-tolerant-and-a-timed-out-providers",
    ],
)
