...
from tests.unit.jobs.utils.rs_utils import Record as BaseRecord, check_request, check_upload_requests, mock_responses, SERVER_DATA
...
class Record(BaseRecord):
    def __init__(
        ...
        attachment = [{"i": i} for i in range(start_index, size)]
        if suggestion_score:
