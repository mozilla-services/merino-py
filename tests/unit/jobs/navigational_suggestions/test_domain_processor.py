...
class TestDomainProcessorIsMatchingDomain:
    ...
    def test_exact_substring_match(self):
        ...
        assert DomainProcessor._is_matching_domain(
    ...
    def test_different_brand_redirect_rejected(self):
        ...
        assert not DomainProcessor._is_matching_domain(
            "uw.edu", "https://www.washington.edu/"
        )
