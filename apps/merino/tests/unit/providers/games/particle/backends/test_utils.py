...
def valid_manifest_data():
    ...
    with open("apps/merino/tests/data/games/particle/runtime-manifest.v1.json") as f:
        return json.load(f)
...
def valid_manifest_data_remote_updated():
    """Load mock response data from the Particle manifest endpoint."""
    with open(
        "apps/merino/tests/data/games/particle/runtime-manifest-remote-updated.v1.json"
    ) as f:
        return json.load(f)
...
def invalid_manifest_data():
    ...
    with open("apps/merino/tests/data/games/particle/invalid-runtime-manifest.v1.json") as f:
        return json.load(f)
...
def manifest_schema_data():
    ...
    with open("apps/merino/tests/data/games/particle/manifest-validation-schema.json") as f:
        return json.load(f)
