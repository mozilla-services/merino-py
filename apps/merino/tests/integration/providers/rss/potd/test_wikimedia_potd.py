...
TEST_FEATURED_JSON = Path(
    "apps/merino/tests/data/rss/wikimedia_potd/potd_featured.json"
...
class TestUploadPictureOfTheDayMethod:
    ...
    async def test_upload_picture_of_the_day_upload_returns_false_when_gcs_upload_fails(
        ...
        assert "wikimedia_potd/2026-06-24/potd.json" not in blob_names
...
class TestUploadImageMethod:
    ...
    def test_thumbnail_upload_only_success(
        ...
        assert blobs_in_bucket[0].name == "wikimedia_potd/2026-06-07/thumbnail.jpeg"
...
class TestBuildAndUploadPotdMethod:
    ...
    async def test_build_and_upload_potd_succeeds(
        ...
        assert potd_manifest_blob.name == "wikimedia_potd/2026-06-07/potd.json"
