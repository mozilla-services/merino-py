---
paths:
  - "apps/merino/merino/jobs/csv_rs_uploader/**"
  - "apps/merino/tests/**/csv_rs_uploader/**"
---
...
1. Create `apps/merino/merino/jobs/csv_rs_uploader/mymodel.py`
...
6. Optionally override `csv_to_suggestions()` for custom filtering (e.g. blocklist)

Usage: `merino-jobs csv-rs-uploader upload --csv-path data.csv --model-name mymodel`

Reference models: `mdn.py` (simple), `pocket.py` (keyword validation), `yelp.py` (complex fields)
