---
paths:
  - "apps/merino/merino/providers/**"
  - "apps/merino/tests/**/providers/**"
---
...
```
apps/merino/merino/providers/suggest/myprovider/
├── __init__.py
...
4. **Custom details** (if returning extra fields): Edit `apps/merino/merino/providers/suggest/custom_details.py`. Add a details model class and an optional field on `CustomDetails`.

5. **Register in manager** (`apps/merino/merino/providers/suggest/manager.py`):
   - Add to `ProviderType` enum
   - Add case in `_create_provider()` factory

6. **Configuration** (`apps/merino/merino/configs/default.toml`):
...
7. **Tests**:
   - `apps/merino/tests/unit/providers/suggest/myprovider/test_provider.py`
   - `apps/merino/tests/unit/providers/suggest/myprovider/backends/test_*.py`
...
- **Simple**: `apps/merino/merino/providers/suggest/geolocation/` (no backend, no caching)
- **With caching + circuit breaker**: `apps/merino/merino/providers/suggest/weather/`
- **With GCS manifest + cron**: `apps/merino/merino/providers/suggest/finance/`
