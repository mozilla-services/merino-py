...
The Navigational Suggestions Job blocklist is contained in `apps/merino/merino/utils/blocklists.py`.
...
## Add to Blocklist
1. Go to [`apps/merino/merino/utils/blocklists.py`][utils-blocklist].
...
[utils-blocklist]: https://github.com/mozilla-services/merino-py/blob/main/apps/merino/merino/utils/blocklists.py
